...
Route::delete('/georef/group/{groupId}/not-georeferenceable', [GeorefController::class, 'unmarkGroupNotGeoreferenceable'])->name('georef.group.not-georeferenceable.undo');
