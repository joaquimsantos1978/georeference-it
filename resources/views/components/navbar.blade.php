    ...
    <div class="w-full px-4 flex items-center justify-between h-full">
        <div class="flex items-center gap-6">
            ...
            <div class="hidden sm:flex items-center gap-5">
                ...
                <a href="{{ route('projects') }}" class="text-sm text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400">{{ __('Projects') }}</a>
                {{-- Community --}}
        ...
        <div class="flex items-center gap-1 sm:gap-3">
            ...
            <div class="sm:hidden flex-shrink-0" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-cloak
                    ...
                    <a href="{{ route('projects') }}" class="block px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700">{{ __('Projects') }}</a>
                    <div class="border-t border-gray-100 dark:border-gray-700 my-1"></div>
