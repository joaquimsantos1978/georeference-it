...
return [
    ...
    */
    ...
    'doesnt_end_with' => 'Поле :attribute не должно оканчиваться ни одним из следующих значений: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute обнаружено в утечке данных. Пожалуйста, выберите другое значение поля :attribute.',
    ],
    ...
    'prohibits' => 'Поле :attribute не позволяет присутствовать полю :other.',
